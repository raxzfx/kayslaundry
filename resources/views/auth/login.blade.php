  ...
  <svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
        ...
        @endif
            <form id="formAuthentication" method="POST" action="{{route('login.proses')}}" class="mb-6" action="index.html">
                @csrf
              <div class="mb-6">
                <label for="email" class="form-label">No Telpon</label>
                <input type="text" class="form-control" id="email" name="no_telp" placeholder="Enter your email or username" autofocus />
              </div>
